...
var Stack = __webpack_require__(18),
    ...
    safeGet = __webpack_require__(45);
...
var _roudokuka = __webpack_require__(170);

var _roudokuka2 = _interopRequireDefault(_roudokuka);

var _pageAnalyzer = __webpack_require__(172);
...
if (analyzer.module.readElements.body.length) {
  chrome.runtime.sendMessage({ method: 'getOptions', key: 'options' }, function (responseOptions) {
    chrome.runtime.sendMessage({ method: 'saveDictionary', dictionary: {
      ...
      for (var key in analyzer.module.readElements) {
        if (options[key] == 'on' && analyzer.module.readElements[key].length) {
          var filteredElements = analyzer.module.readElements[key].filter(function (index, element) {
...
var compareAscending = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Libretto__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_merge__ = __webpack_require__(54);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_merge__ = __webpack_require__(54);
...
var _find2 = __webpack_require__(55);

var _find3 = _interopRequireDefault(_find2);

var _narou = __webpack_require__(173);
...
var Narou = function Narou() {
  ...
  var elementArray = ['.novel_subtitle', '#novel_p p', '#novel_honbun p', '#novel_a p'];
  this.readElements = {
