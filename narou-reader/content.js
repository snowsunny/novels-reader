...
var lineUnHighlight = function lineUnHighlight() {
  (0, _jquery2.default)('#node_p p, #novel_honbun p, #node_a p').removeClass('highlight');
};

// start main --------
if ((0, _jquery2.default)('#novel_honbun').length) {
  ...
  var afterword = (0, _jquery2.default)('#node_a');
  ...
  (0, _jquery2.default)('.controll-button.play').on('click', function (e) {
    var targetPlayButton = (0, _jquery2.default)(e.currentTarget);
    lineUnHighlight();
    lineHighlight(targetPlayButton.parent());
    window.roudokuka.start(targetPlayButton.data().index);
  });

  (0, _jquery2.default)('body').append((0, _jquery2.default)('<div class=\'controll-button stop\'></div>').click(function (e) {
    window.roudokuka.stop();
  }));

  window.roudokuka = new _roudokuka2.default(linesInfo, {
    onend: function onend(e, lineInfo) {
      lineUnHighlight();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_merge__ = __webpack_require__(14);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_merge__ = __webpack_require__(14);
